...
import { Sheet, SheetContent } from "@classy/ui/components/sheet";
import { Skeleton } from "@classy/ui/components/skeleton";
    ...
    if (isMobile) {
      return (
        <Sheet open={openMobile} onOpenChange={setOpenMobile} {...props}>
          ...
          >
            <VisuallyHidden>
              <DialogTitle>Accesible pero oculto</DialogTitle>
            </VisuallyHidden>
